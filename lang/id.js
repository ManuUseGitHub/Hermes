module.exports = {
    accepted_adhesion : 
    `Hore! Keanggotaan Anda di **ziQuatorze** telah divalidasi oleh moderator. Anda sekarang dapat menikmati server sepenuhnya.
...
- 3: tema pemilik server (opsional)` ,
    greetings : 
    `Halo ! Ini adalah kesenangan untuk memiliki Anda dengan kami. Ingin memastikan hubungan baik di server kami, kami ingin menganalisis setiap pendatang baru untuk memastikan bahwa pembelajaran setiap orang berlangsung dalam kondisi terbaik.
