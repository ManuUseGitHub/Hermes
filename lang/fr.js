...
module.exports = {
    accepted_adhesion :
    `Hourra ! Votre adhésion sur **ziQuatorze** a été validée par un modérateur. Vous pouvez maintenant profiter plainement du server.
...
- 3: les thématiques du propriétaire du server (optionel)` ,
    greetings : 
    `Bonjour ! C'est un plaisir de vous compter parmi nous. Voulant assurer la bonne entente sur notre serveur, nous désirons analyser tout nouvel arrivant pour nous assurer que l'apprentissage de chacun se fasse dans les meilleures conditions.
